...
public class MockPlayer implements Player {
    ...
    public static final String PLAYER_TEST_NAME = "PLAYER_TEST";
    public static final UUID PLAYER_TEST_UUID = UUID.fromString("92e3b2dc-bfc5-4ba6-a50f-1f22f10be2a3");
    ...
    public MockPlayer() {
        this.name = PLAYER_TEST_NAME;
        this.uuid = PLAYER_TEST_UUID;
    }
